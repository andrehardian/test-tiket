package com.test.testtiket.common
...
import com.test.testtiket.ui.activity.SearchListener
import com.test.testtiket.ui.components.GravitySnapHelper
import com.test.testtiket.ui.components.NestedScrollViewOverScrollDecorAdapter
import com.test.testtiket.util.GlideApp
...
object CommonSetter {
    @JvmStatic
    @BindingAdapter("onSearchDone")
    fun onSearchDone(view: TextView, listener: SearchListener) {
        view.setOnEditorActionListener(TextView.OnEditorActionListener { textView, i, keyEvent ->
            if (i == EditorInfo.IME_ACTION_SEARCH) {
                listener.searchDone(view.text.toString())
                true
            } else {
                false
            }
